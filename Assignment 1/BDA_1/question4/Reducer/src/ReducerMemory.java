...
public class ReducerMemory {
	...
	public static void main(String[] args) throws Exception 
	{
		...
		{
			System.err.println("Usage: ReducerMemory <inmemory input> <input > <input> <intermediate output> <output>");
			System.exit(2);
		}
		
		Job job = new Job (conf, "join1 ");
		job.setJarByClass(ReducerMemory.class);
		...
		job1.setJarByClass(ReducerMemory.class);
