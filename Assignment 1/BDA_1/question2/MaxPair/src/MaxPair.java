...
public class MaxPair {
	...
	public static class Pair_Map1 extends Mapper<LongWritable, Text, Text, Text> {
	...
	public static class Pair_Reduce1 extends Reducer<Text, Text, Text, IntWritable> {
	...
	public static class Pair_Map2 extends Mapper<LongWritable, Text, IntWritable, Text> {
	...
	public static class Pair_Reduce2 extends Reducer<IntWritable, Text, Text, IntWritable> {
...
//Defining ValueCopmarator explicitly so that we can sort the map in Descending Order
	...
	public static void main(String[] args) throws Exception{
		...
		Job job = new Job(conf, "Maxpair Phase 1");
		job.setJarByClass(MaxPair.class);
		job.setMapperClass(Pair_Map1.class);
		job.setReducerClass(Pair_Reduce1.class);
		...
		if (mapreduce) {
			...
			@SuppressWarnings("deprecation")
			Job job1 = new Job(conf1, "Maxpair Phase 2");
			job1.setJarByClass(MaxPair.class);
			job1.setMapperClass(Pair_Map2.class);
			job1.setReducerClass(Pair_Reduce2.class);
